...
function draw() {
  ...
  else if (currentScreen === "DecisionOneA") drawDecOneA();
  else if (currentScreen === "DecisionOneB") drawDecOneB();
  else if (currentScreen === "EndingA") drawEndingA();
  else if (currentScreen === "EndingB") drawEndingB();
...
function mousePressed() {
  ...
  else if (currentScreen === "DecisionOneA") DecisionOneAMousePressed();
  else if (currentScreen === "DecisionOneB") DecisionOneBMousePressed();
  // The ?.() means “call this function only if it exists”
  // This prevents errors if a screen doesn’t implement a handler.
  else if (currentScreen === "EndingA") endAMousePressed();
  else if (currentScreen === "EndingB") endBMousePressed();
}
